...
> 実際にコマンドを実行して結果を記録する。LLM の記憶や読み込みに頼らない。
...
> 各子チケットのファイルを実際に読んで確認する。「たぶん書いてあった」は不可。

| チェック項目 | 参照ファイル | 判定 |
|------------|-----------|------|
| ディレクトリ構造・主要フォルダの役割把握 | SP-001-01.md | Pass / Fail / Uncertain |
| 技術スタック・エントリポイントの特定 | SP-001-01.md + SP-001-02.md | Pass / Fail / Uncertain |
| ドキュメントとコードの食い違い確認 | SP-001-03.md | Pass / Fail / Uncertain |
| コメント・docstring の量・質 | SP-001-03.md | Pass / Fail / Uncertain |
| 環境構成・担当者の把握 | SP-001-03.md | Pass / Fail / Uncertain |
| コンテキストファイル設計の完了 | SP-001-context.md | Pass / Fail / Uncertain |
